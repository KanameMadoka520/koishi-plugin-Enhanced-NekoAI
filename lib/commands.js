  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'neko.生图 【提示词】', description: '支持 --count / --ratio / --resolution / --model / --node' },
        { title: 'neko.修图 【提示词】', description: '支持 --ratio / --resolution / --model / --node，图片来自当前消息或引用' },
      ],
    },
    {
      title: '人格管理',
...
neko.生图 【提示词】 — 支持 --count / --ratio / --resolution / --model / --node
neko.修图 【提示词】 — 支持 --ratio / --resolution / --model / --node
