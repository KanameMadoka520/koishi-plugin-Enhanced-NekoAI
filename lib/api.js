...
async function postOpenAiImageMultipartRequest(ctx, requestUrl, fields, sourceImages, headers) {
  ...
  return enqueue(() => ctx.http.post(requestUrl, form, { headers, timeout: getApiTimeoutMs() }));
}
...
async function postOpenAiCompatibleImageChatRequest(ctx, requestUrl, resolvedModel, cleanPrompt, sourceImages, headers) {
  ...
  return enqueue(() => ctx.http.post(requestUrl, payload, { headers, timeout: getApiTimeoutMs() }));
}
...
module.exports = { getAiReply, generateXaiImages, generateOpenAiImages, generateImages };
