...
const state = {
  ...
  groupMemoryTimers: {},  // 群聊上下文自动清理定时器 { channelId: timeoutId }
  groupMemoryActivityAt: {}, // 群聊最近一次新增上下文时间 { channelId: timestamp }

  // --- 私聊运行时状态 ---
  singleMessages: {},     // 私聊上下文 { userId: string[] }
  privateIntervals: {},   // 私聊防抖定时器 { userId: timeoutId }
  privateMemoryTimers: {},// 私聊上下文自动清理定时器 { userId: timeoutId }
  privateMemoryActivityAt: {}, // 私聊最近一次新增上下文时间 { userId: timestamp }
  ...
  // --- 群聊限流计数 ---
  usageData: { periodId: "", counts: {}, users: {} },
  imageUsageData: { periodId: "", users: {} },
  usageEventData: { schemaVersion: 1, events: [] },
