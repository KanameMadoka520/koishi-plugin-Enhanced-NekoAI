...
const name = "tcy-nekoai";
const usage = `
TCY 自用多模态拟人 AI 聊天插件 (模块化架构版)
...
const defaultApiConfig = [
  { "apiUrl": "https://api.example.com/v1/chat/completions", "modelName": "gpt-4o", "apiKey": "sk-xxx", "remark": "默认中转站", "aiType": "openai" }
];
