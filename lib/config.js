...
function loadAllConfigs() {
  ...
  if (!fs.existsSync(runPath)) {
    ...
    try {
      ...
      // 深层补丁：smartRouter / apiParams / memorySummary / requestQueue / imageAccess / imageQuota / _comments
      for (const deepKey of ['smartRouter', 'apiParams', 'memorySummary', 'requestQueue', 'imageAccess', 'imageQuota', '_comments']) {
