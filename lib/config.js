...
const defaultRuntimeConfig = {
  "_comments": {
    ...
    "activeApiIndex": "当前使用的API节点编号（对应 api_config.json 的索引，从 0 开始）",
...
const defaultApiConfig = [
  { "apiUrl": "https://api.example.com/v1/chat/completions", "modelName": "gpt-4o-mini", "apiKey": "sk-your-openai-compatible-key", "remark": "OpenAI 兼容示例", "aiType": "openai", "xaiWebSearchEnabled": false, "xaiImageEnabled": false, "xaiImageGenerationUrl": "", "xaiImageEditUrl": "", "xaiImageModel": "", "xaiImageAspectRatio": "", "xaiImageResolution": "" },
  { "apiUrl": "https://api.openai.com/v1/responses", "modelName": "gpt-4o-mini", "apiKey": "sk-your-openai-key", "remark": "OpenAI Responses 示例", "aiType": "responses", "xaiWebSearchEnabled": false, "xaiImageEnabled": false, "xaiImageGenerationUrl": "", "xaiImageEditUrl": "", "xaiImageModel": "", "xaiImageAspectRatio": "", "xaiImageResolution": "" },
  { "apiUrl": "https://api.anthropic.com/v1/messages", "modelName": "claude-3-5-sonnet-latest", "apiKey": "sk-ant-your-anthropic-key", "remark": "Anthropic 示例", "aiType": "anthropic", "xaiWebSearchEnabled": false, "xaiImageEnabled": false, "xaiImageGenerationUrl": "", "xaiImageEditUrl": "", "xaiImageModel": "", "xaiImageAspectRatio": "", "xaiImageResolution": "" },
  { "apiUrl": "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent", "modelName": "gemini-2.0-flash", "apiKey": "AIza-your-gemini-key", "remark": "Gemini 示例", "aiType": "gemini", "xaiWebSearchEnabled": false, "xaiImageEnabled": false, "xaiImageGenerationUrl": "", "xaiImageEditUrl": "", "xaiImageModel": "", "xaiImageAspectRatio": "", "xaiImageResolution": "" }
];
...
function loadAllConfigs() {
  ...
  if (!fs.existsSync(runPath)) {
    ...
    try {
      ...
      // 深层补丁：smartRouter / apiParams / memorySummary / requestQueue / _comments
      for (const deepKey of ['smartRouter', 'apiParams', 'memorySummary', 'requestQueue', '_comments']) {
  ...
  logger.critical(`配置全量加载完毕 (API节点:${state.apiList.length} | 群聊人格:${state.groupPersonalityList.length} | 私聊人格:${state.privatePersonalityList.length} | 黑名单:${state.userBlacklist.length}人 | 智能路由:${state.runtimeConfig.smartRouter?.enabled ? '开' : '关'})`);
}
...
module.exports = {
  ...
  saveGroupPersonality, savePrivatePersonality, saveUsageCounts
};
